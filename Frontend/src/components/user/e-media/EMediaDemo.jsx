...
import { Button, Row, Col, DatePicker, Typography, Divider } from "antd";
import axios from "axios";
          ...
          <div className="row">
            ...
            <div className="col-lg-12">
              <Row align="middle" style={{ height: '30px', backgroundColor: 'white' }}>
                <Col flex="none">
                  <Title level={4} style={{ margin: 0, paddingRight: 10 }}>E-MEDIA FINANCIAL STATUS</Title>
                </Col>
              </Row><br />
              <div className="row">
                <div className="col-xxl-4 col-md-12">
                  <div className="card info-card revenue-card" style={{ maxWidth: "300px", height: "120px", }}   >
                    <div className="card-body" style={{ paddingTop: "0.0rem", paddingBottom: "0.0rem", paddingLeft: "0.0rem", paddingRight: "0.0rem" }}  >
                      <div style={{ maxWidth: "300px", backgroundColor: "#ffc0cb  ", paddingLeft: "0.5rem", paddingRight: "0.5rem" }}>
                ...
                <div className="col-xxl-4 col-md-12">
                  <div className="card info-card revenue-card" style={{ maxWidth: "300px", height: "120px" }}>
                    <div></div>
                    <div className="card-body" style={{ paddingTop: "0.0rem", paddingBottom: "0.0rem", paddingLeft: "0.0rem", paddingRight: "0.0rem" }}>
                      <div style={{ maxWidth: "300px", backgroundColor: "#ffc0cb  " }}>
